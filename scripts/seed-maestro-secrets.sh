...
SECRETS=(
    ...
    "jam/search/brave|single|optional|Brave Search API key. Search router will skip this backend if absent (§4.8)."
    "jam/search/firecrawl|single|optional|Firecrawl URL-fetch + scrape API key."
    "jam/search/exa|single|optional|Exa neural-search API key."
    "jam/search/linkup|single|optional|Linkup search API key."
    "jam/search/perplexity|single|optional|Perplexity Sonar search API key."
    "jam/search/tavily|single|optional|Tavily search API key."
